      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <CommandCard accentColor="#38BDF8" title="SCENARIO AUTHORING" indicator>
          <div className="bg-s3m-elevated border border-s3m-border-default rounded p-6 mb-4 text-center">
            ...
            <div className="text-lg text-s3m-text-tertiary mb-4">
              No active scenario
            </div>
            <button className="bg-s3m-cyan text-s3m-base px-4 py-2 rounded text-lg font-semibold uppercase tracking-wider hover:bg-s3m-cyan/90 transition-colors">
              NEW SCENARIO
            </button>
          </div>

          <div>
            <div className="text-lg text-s3m-text-tertiary uppercase tracking-wider mb-3">
              RECENT SCENARIOS
            </div>
              ...
              {scenarios.map((scenario, i) => (
                ...
                >
                  <div className="flex items-start justify-between mb-1">
                    <span className="font-mono text-lg text-s3m-text-tertiary">
                      {scenario.id}
                    </span>
                    <span className="text-lg uppercase tracking-wider text-s3m-operational">
                      {scenario.status}
                    </span>
                  </div>
                  <div className="text-lg text-s3m-text-primary mb-1">
                    {scenario.name}
                  </div>
        ...
        <CommandCard accentColor="#22C55E" title="AFTER ACTION REVIEW" indicator>
          <div className="mb-4 pb-4 border-b border-s3m-border-default">
            <div className="flex items-start justify-between mb-2">
              <div>
                <div className="font-mono text-lg text-s3m-text-tertiary mb-1">SIM-003</div>
                <div className="text-lg font-semibold text-s3m-text-primary mb-1">
                  Multi-Domain Strike
                </div>
                <div className="text-lg text-s3m-text-tertiary">2026-04-01</div>
              </div>
              <div className="text-right">
                <div className="text-lg text-s3m-text-tertiary uppercase tracking-wider mb-1">
                  OUTCOME
                </div>
                <div className="text-lg font-semibold text-s3m-operational">
                  MISSION SUCCESS
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mt-3">
              <div className="bg-s3m-elevated rounded p-2">
                <div className="text-lg text-s3m-text-tertiary uppercase mb-0.5">Duration</div>
                <div className="font-mono text-lg text-s3m-text-secondary">2h 14m</div>
              </div>
              <div className="bg-s3m-elevated rounded p-2">
                <div className="text-lg text-s3m-text-tertiary uppercase mb-0.5">Blue KIA</div>
                <div className="font-mono text-lg text-s3m-operational">0</div>
              </div>
              <div className="bg-s3m-elevated rounded p-2">
                <div className="text-lg text-s3m-text-tertiary uppercase mb-0.5">OPFOR</div>
                <div className="font-mono text-lg text-s3m-text-secondary">2/3</div>
              </div>
            </div>
          </div>

          <div className="mb-4">
            <div className="text-lg text-s3m-text-tertiary uppercase tracking-wider mb-2 flex items-center gap-1">
              <FileText className="w-3 h-3" />
              KEY FINDINGS
            </div>
            <div className="space-y-1.5">
              {findings.map((finding, i) => (
                <div key={i} className="flex gap-2 text-lg text-s3m-text-secondary">
            ...
            <div className="space-y-2">
              {lessons.map((lesson, i) => (
                <div key={i} className="border-l-2 border-s3m-caution bg-s3m-caution/5 pl-3 py-2 rounded">
                  <div className="flex gap-2 text-lg text-s3m-text-secondary">
            ...
            {scenarioLibrary.map((category) => (
              <div key={category.category} className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-3">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-lg text-s3m-text-primary font-semibold uppercase">
                    {category.category}
                  </span>
                </div>
                <div className="space-y-2">
            ...
            {missionRehearsalScenarios.map((scenario) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-lg uppercase tracking-wider text-s3m-green px-1.5 py-0.5 rounded" style={{ background: '#22C55E20', border: '1px solid #22C55E40' }}>
                    {scenario.status}
                  </span>
                </div>
                <div className="bg-s3m-card rounded p-2 mb-2">
                  <div className="text-lg text-s3m-text-tertiary uppercase mb-1">Degradation</div>
                  <div className="text-lg text-s3m-text-primary">{scenario.degradation}</div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-lg text-s3m-text-tertiary uppercase">Confidence</span>
                  <span className="text-lg font-mono font-semibold" style={{ color: getConfidenceColor(scenario.confidence) }}>
                    {scenario.confidence}%
                  </span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[humanAIComparison.humanCOA, humanAIComparison.aiCOA, humanAIComparison.blendedCOA].map((coa) => (
              <div key={coa.name} className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-3">
                <div className="text-lg text-s3m-text-primary font-semibold mb-3 text-center">
                  {coa.name}
                </div>

                <div className="space-y-2 mb-3">
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Success Rate</span>
                    <span className="text-lg font-mono font-semibold text-s3m-green">{coa.successRate}%</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Casualties</span>
                    <span className="text-lg font-mono font-semibold text-s3m-text-primary">{coa.casualties}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Time</span>
                    <span className="text-lg font-mono font-semibold text-s3m-text-primary">{coa.timeToComplete}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Resources</span>
                    <span className="text-lg font-mono font-semibold text-s3m-cyan">{coa.resourceUtilization}%</span>
                  </div>
                </div>

                <div className="bg-s3m-card rounded p-2">
                  <div className="text-lg text-s3m-text-tertiary uppercase mb-1">Objectives</div>
      ...
      <div className="bg-s3m-card border border-s3m-border-default rounded-lg p-3">
        ...
        {expandedAAR && (
          <div className="space-y-3">
            {/* Key Decision Points */}
            <div>
              <div className="text-lg text-s3m-text-tertiary uppercase tracking-wider font-semibold mb-2">
                Key Decision Points
              </div>
              <div className="space-y-2">
                  ...
                  <div key={idx} className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-2">
                    <div className="flex items-start justify-between mb-1">
                      <div className="flex items-center gap-2">
                        <span className="font-mono text-lg text-s3m-text-tertiary">{decision.time}</span>
                        <span className="text-lg text-s3m-text-primary">{decision.decision}</span>
                      </div>
                      <span
              ...
              <div>
                ...
                <div className="space-y-2">
                  {aarData.avoidableLosses.map((loss, idx) => (
                    <div key={idx} className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-2">
                      <div className="text-lg text-s3m-text-primary font-semibold mb-1">{loss.asset}</div>
                      <div className="text-lg text-s3m-text-tertiary mb-1">Reason: {loss.reason}</div>
                      <div className="flex items-center justify-between text-lg">
                        <span style={{ color: loss.preventable === 'Yes' ? '#EF4444' : '#22C55E' }}>
                          Preventable: {loss.preventable}
                        </span>
                      </div>
                      <div className="text-lg text-s3m-cyan mt-1">{loss.recommendation}</div>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  {aarData.missedDetections.map((detection, idx) => (
                    <div key={idx} className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-2">
                      <div className="flex items-center justify-between mb-1">
                        <div className="text-lg text-s3m-text-primary font-semibold">{detection.target}</div>
                        <span className="font-mono text-lg text-s3m-text-tertiary">{detection.time}</span>
                      </div>
                      <div className="text-lg text-s3m-text-tertiary mb-1">{detection.reason}</div>
                      <span
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Human Avg</span>
                    <span className="text-lg font-mono font-semibold text-s3m-text-primary">{aarData.timeToDecision.avgHuman}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">AI Avg</span>
                    <span className="text-lg font-mono font-semibold text-s3m-cyan">{aarData.timeToDecision.avgAI}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Blended Avg</span>
                    <span className="text-lg font-mono font-semibold text-s3m-green">{aarData.timeToDecision.avgBlended}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Optimal Rate</span>
                    <span className="text-lg font-mono font-semibold text-s3m-green">
              ...
              <div className="bg-s3m-elevated border border-s3m-border-default rounded-lg p-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    ...
                    <span className="text-lg font-mono font-semibold text-s3m-text-primary">{aarData.recommendationQuality.aiRecommendations}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Accepted</span>
                    <span className="text-lg font-mono font-semibold text-s3m-green">{aarData.recommendationQuality.accepted}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Rejected</span>
                    <span className="text-lg font-mono font-semibold text-s3m-text-primary">{aarData.recommendationQuality.rejected}</span>
                  </div>
                  <div className="flex items-center justify-between bg-s3m-card rounded p-1.5">
                    <span className="text-lg text-s3m-text-tertiary uppercase">Accuracy</span>
                    <span className="text-lg font-mono font-semibold text-s3m-cyan">{aarData.recommendationQuality.accuracy}%</span>
                  </div>
                </div>
              </div>
            </div>
